...
unit_test() ->
    [
     ...
     ?_assertEqual("<table>\n<img src=\"http://example.com\">\n</table>",
                   erlmarkdown:conv("<table>\n<img src=\"http://example.com\">\n</table>")),
     ?_assertEqual("<h3>\nLets let html through\n</h3>",
                   erlmarkdown:conv("<h3>\nLets let html through\n</h3>")),
     ?_assertEqual("<p>&copy;</p>", erlmarkdown:conv("&copy;")),
     ?_assertEqual("<h3 id='test'>\nLets let html through\n</h3>",
                   erlmarkdown:conv("<h3 id='test'>\nLets let html through\n</h3>")),
     ?_assertEqual("<p><img src=\"_underscore\" alt=\"login\" title=\"\" /></p>",
                   erlmarkdown:conv("![login](_underscore)")),
     ?_assertEqual("<p><a href=\"_underscore\">login</a></p>",
                   erlmarkdown:conv("[login](_underscore)")),
     ?_assertEqual("<ol>\n<li>should be <em>italic</em></li>\n"
                   "<li>should be <strong>bold</strong></li>\n<li>should be "
                   "<strong><em>bold italic</em></strong></li>\n</ol>",
                   erlmarkdown:conv("\n 1.   should be *italic*\n 2.  should be "
                                    "**bold**\n 3.  should be ***bold italic***")),
     ?_assertEqual("<ul>\n<li>should be <em>italic</em></li>\n<li>should be "
                   "<strong>bold</strong></li>\n<li>should be <strong><em>bold"
                   " italic</em></strong></li>\n</ul>",
                   erlmarkdown:conv("\n - should be *italic*\n - should be "
                                    "**bold**\n - should be ***bold italic***")),
     ?_assertEqual("<p>some stuff <code>yaycode</code> more stuff <code>more code!</code></p>",
                   erlmarkdown:conv("some stuff `yaycode` more stuff `more code!`")),
     ?_assertEqual("<p><a href=\"http://example.com/some/link\"><img "
                   "src=\"/img/somebutton.png\" alt=\"Button\" title=\"\" />"
                   "</a></p>",
                   erlmarkdown:conv("[![Button](/img/somebutton.png)](http://example.com/some/link)")),
     ?_assertEqual("<pre><code>alice\nbob\n</code></pre>\n\n<p>chaz</p>",
                   erlmarkdown:conv("    alice\n    bob\nchaz")),
     ?_assertEqual("<blockquote>\n  <p>alice\n  bob\n  chaz</p>\n</blockquote>",
                   erlmarkdown:conv("> alice\n> bob\n> chaz")),
     ?_assertEqual("<ul>\n<li>a</li>\n<li>b</li>\n</ul>", erlmarkdown:conv(" - a\n - b\n")),
     ?_assertEqual("<ol>\n<li>a</li>\n<li>b</li>\n</ol>", erlmarkdown:conv(" 1. a\n 2. b\n")),
     ?_assertEqual("<p>blah <img src=\"http://example.com\" alt=\"blah\" "
                   "title=\"title\" /> blah</p>",
                   erlmarkdown:conv("blah ![blah][1] blah\n\n\n  [1]: http://example.com (title)")),
     ?_assertEqual("<p>blah <img src=\"http://example.com\" alt=\"blah\" "
                   "title=\"title\" /> blah</p>",
                   erlmarkdown:conv("blah ![blah][1] blah\n\n\n  [1]: http://example.com \"title\"")),
     ?_assertEqual("<p>blah <img src=\"http://example.com\" alt=\"blah\" "
                   "title=\"\" /> blah</p>",
                   erlmarkdown:conv("blah ![blah][1] blah\n\n\n  [1]: http://example.com")),
     ?_assertEqual("<p>Now is the winter of <code>our discontent</code> made "
                   "glorious summer by this Son of York</p>",
                   erlmarkdown:conv("Now is the winter of `our discontent` made"
                                    " glorious summer by this Son of York")),
     ?_assertEqual("<p>blah <a href=\"http://example.com\" title=\"title\">blah""</a> blah</p>",
                   erlmarkdown:conv("blah [blah][1] blah\n\n\n  [1]: http://example.com (title)")),
     ?_assertEqual("<p>blah <a href=\"http://example.com\" title=\"title\">blah</a> blah</p>",
                   erlmarkdown:conv("blah [blah][1] blah\n\n\n  [1]: http://example.com \"title\"")),
     ?_assertEqual("<p>blah <a href=\"http://example.com\">blah</a> blah</p>",
                   erlmarkdown:conv("blah [blah][1] blah\n\n\n  [1]: http://example.com")),
     ?_assertEqual("<h2>> blah</h2>", erlmarkdown:conv("> blah\n-------------")),
     ?_assertEqual("", erlmarkdown:conv("  \n")),
     ?_assertEqual("<p><img src=\"http://example.com\" alt=\"alt text\" title=\"\" /></p>",
                   erlmarkdown:conv("![alt text][1]\n\n[1]: http://example.com")),
     ?_assertEqual("<p><img src=\"http://example.com\" alt=\"alt text\" title=\"optional title\" /></p>",
                   erlmarkdown:conv("![alt text][1]\n\n[1]: http://example.com \"optional title\"")),
     ?_assertEqual("<p><a href=\"http://example.com\">link text</a></p>",
                   erlmarkdown:conv("[link text][1]\n\n[1]: http://example.com")),
     ?_assertEqual("<p><a href=\"http://example.com\" title=\"optional title\">link text</a></p>",
                   erlmarkdown:conv("[link text][1]\n\n[1]: http://example.com \"optional title\"")),
     ?_assertEqual("<p>blah</p>\n\n<p>bleh</p>",
                   erlmarkdown:conv("blah\n\n\nbleh")),
     ?_assertEqual("<p><code>&lt;div&gt;blah&lt;/div&gt;</code></p>",
                   erlmarkdown:conv("`<div>blah</div>`")),
     ?_assertEqual("<p>My <a href=\"http://example.com\">link</a> test</p>",
                   erlmarkdown:conv("My [link][id] test\n[id]: http://example.com")),
     ?_assertEqual("<p>My <a href=\"http://example.com\">id</a> test</p>",
                   erlmarkdown:conv("My [id] test\n[id]: http://example.com")),
     ?_assertEqual("<p>blah <a href=\"https://something.com:1234/a/path\">https://something.com:"
                   "1234/a/path</a> blah\na</p>",
                   erlmarkdown:conv("blah <https://something.com:1234/a/path> blah\na")),
     ?_assertEqual("<p>blah <a href=\"http://something.com:1234/a/path\">http://something.com:"
                   "1234/a/path</a> blah\na</p>",
                   erlmarkdown:conv("blah <http://something.com:1234/a/path> blah\na")),
     ?_assertEqual("<p>Some text <img src=\"/a/path\" alt=\"hey\" title=\"\" /> there\na</p>",
                   erlmarkdown:conv("[id]: /a/path\nSome text ![hey] [id] there\na")),
     ?_assertEqual("<p>Some text <img src=\"/a/path\" alt=\"hey\" title=\"\" /> there\na</p>",
                   erlmarkdown:conv("[id]: /a/path\nSome text ![hey][id] there\na")),
     ...
     ?_assertEqual("<p>bleh</p>\n\n<blockquote>\n  <p>blah</p>\n</blockquote>",
                   erlmarkdown:conv("bleh\n> blah")),
     ?_assertEqual("<blockquote>\n  <p>blah\n  a</p>\n</blockquote>",
                   erlmarkdown:conv("> blah\na")),
     ?_assertEqual("<h1>blahblah</h1>\n\n<p>bleh</p>",
                   erlmarkdown:conv("# blahblah ###\nbleh")),
     ...
     ?_assertEqual("<p><strong><em>you</em></strong> sad bastard\na</p>",
                   erlmarkdown:conv("___you___ sad bastard\na")),
     ?_assertEqual("<p><strong>you</strong> sad bastard\na</p>",
                   erlmarkdown:conv("__you__ sad bastard\na")),
     ?_assertEqual("<p><em>you</em> sad bastard\na</p>",
                   erlmarkdown:conv("_you_ sad bastard\na")),
     ?_assertEqual("<p><strong><em>you</em></strong> sad bastard\na</p>",
                   erlmarkdown:conv("***you*** sad bastard\na")),
     ?_assertEqual("<p><strong>you</strong> sad bastard\na</p>",
                   erlmarkdown:conv("**you** sad bastard\na")),
     ?_assertEqual("<p><em>you</em> sad bastard\na</p>",
                   erlmarkdown:conv("*you* sad bastard\na")),
     ?_assertEqual("<p>you _sad_ bastard\na</p>",
                   erlmarkdown:conv("you \\_sad\\_ bastard\na")),
     ?_assertEqual("<p>you *sad* bastard\na</p>",
                   erlmarkdown:conv("you \\*sad\\* bastard\na")),
     ?_assertEqual("<p>you<em>sad</em>bastard\na</p>",
                   erlmarkdown:conv("you_sad_bastard\na")),
     ?_assertEqual("<p>you<em>sad</em>bastard\na</p>",
                   erlmarkdown:conv("you*sad*bastard\na")),
     ?_assertEqual("<p>you <strong><em>sad</em></strong> bastard\na</p>",
                   erlmarkdown:conv("you ___sad___ bastard\na")),
     ?_assertEqual("<p>you <strong>sad</strong> bastard\na</p>",
                   erlmarkdown:conv("you __sad__ bastard\na")),
     ?_assertEqual("<p>you <em>sad</em> bastard\na</p>",
                   erlmarkdown:conv("you _sad_ bastard\na")),
     ?_assertEqual("<p>you <strong><em>sad</em></strong> bastard\na</p>",
                   erlmarkdown:conv("you ***sad*** bastard\na")),
     ?_assertEqual("<p>you <strong>sad</strong> bastard\na</p>",
                   erlmarkdown:conv("you **sad** bastard\na")),
